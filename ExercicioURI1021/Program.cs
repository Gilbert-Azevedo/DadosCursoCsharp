        ...
        static void Main(string[] args)
        {
            ...
            double n100 = Math.Floor(parteint/100.00);
               ...
               double m1 = Math.Floor(parteint);
                ...
                partefrac = partefrac % 2.5;
                 
               double m01 = Math.Floor(partefrac / 10);
                partefrac = partefrac % 1;
               double m005 = Math.Floor(partefrac / 5);
                partefrac = partefrac % 0.5;
              
               double m001 = Math.Floor(partefrac / 1);
               ...
               Console.WriteLine($"{m1:0} moedas(s) de R$ 1.00");
               Console.WriteLine($"{m05:0} moedas(s) de R$ 0.50");
               Console.WriteLine($"{m025:0} moedas(s) de R$ 0.25");
               Console.WriteLine($"{m01:0} moedas(s) de R$ 0.10");
               Console.WriteLine($"{m005:0} moedas(s) de R$ 0.05");
               Console.WriteLine($"{m001:0} moedas(s) de R$ 0.01"); 
